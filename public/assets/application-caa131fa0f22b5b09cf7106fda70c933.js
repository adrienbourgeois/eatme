...
(function() {
  var close_places, close_places_loading, end_close_places, end_just_eaten, getDocHeight, initialize_map, just_eaten_loading, last_page, latitude, latitude_user, load_more_listener_off, load_more_listener_on, load_more_photos_when_page_bottom_reached, loading, longitude, longitude_user, map, marker, page_close_places, page_just_eaten, popular_places, rayon_gv, refresh_listeners, show_map_listener, show_place, show_place_listener, spinner_off, spinner_on;
  ...
  load_more_photos_when_page_bottom_reached = function() {
    if ($(window).height() + $(window).scrollTop() - getDocHeight() > -200) {
      ...
      if (window.location.hash === "#close_places" && rayon_gv !== -1 && !end_close_places) {
        return close_places_loading(rayon_gv);
      }
    }
  };
  ...
  close_places_loading = function(rayon) {
    return $.ajax({
  ...
  close_places = function(rayon) {
    ...
    if (navigator.geolocation) {
      return navigator.geolocation.getCurrentPosition(function(position) {
        ...
        return close_places_loading(rayon);
      });
    } else {
