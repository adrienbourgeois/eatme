...
(function() {
  var close_places_loading, end, first_time, getDocHeight, get_location, get_popular_places, init, initialize, just_eaten, just_eaten_loading, last_page, latitude, latitude_user, load_more_listener_off, load_more_listener_on, load_more_photos_when_page_bottom_reached, longitude, longitude_user, map, marker, page_just_eaten, show_map_listener, show_place;
  ...
  just_eaten_loading = function() {
    return $.ajax({
      ...
      success: function(ret) {
        ...
        if (ret.length % 3 !== 0 || ret.length === 0) {
          end = true;
        }
  ...
  load_more_photos_when_page_bottom_reached = function() {
    if ($(window).height() + $(window).scrollTop() - getDocHeight() > -200) {
      return just_eaten_loading(event);
    }
  };
  ...
  just_eaten = function() {
    ...
    load_more_listener_off();
    load_more_listener_on();
    return $("#myModal").on("shown.bs.modal", function() {
