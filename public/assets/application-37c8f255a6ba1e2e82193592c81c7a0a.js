  ...
  load_more_photos = function() {
    return $.ajax({
      ...
      beforeSend: function() {
        ...
        spinner = $("<li><center><img src=\"spiffygif.gif\"></img></center></li>");
        $("ul.edgetoedge#bottom_just_eaten").find("li").remove();
        return $("ul.edgetoedge#bottom_just_eaten").append(spinner);
      },
      complete: function() {
