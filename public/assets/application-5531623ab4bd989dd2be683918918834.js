...
(function() {
  ...
  show_place = function(id) {
    ...
    return $.ajax({
      ...
      contentType: "application/json",
      success: function(ret) {
        var author, body_review, center, content, image, imgs_list, j, li, link2, name, review, review_div, reviews, reviews_div, vicinity, _i, _j, _len, _ref;
        console.log(ret);
        if (ret.length === 0) {
          li = $("<li><center><p>No results found</p></center></li>");
    ...
    return $("#submit_review").on("click", function(event) {
      ...
      return $.ajax({
        ...
        success: function(review) {
          var author, body_review, review_div, reviews_div;
          ...
          review_div.append(author);
          review_div.append(body_review);
          return reviews_div.prepend(review_div);
        },
        complete: function() {},
        data: form.serialize()
      });
