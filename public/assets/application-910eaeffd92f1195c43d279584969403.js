...
(function() {
  var end, first_time, getDocHeight, get_close_places, get_location, init, initialize, just_eaten, latitude, latitude_user, load_more_listener_off, load_more_listener_on, load_more_photos, load_more_photos_when_page_bottom_reached, longitude, longitude_user, map, marker, page, show_map_listener, show_place;
  ...
  load_more_photos = function() {
    return $.ajax({
      ...
      success: function(ret) {
        var i, image, li, link2, minutes_ago, titre, vicinity, _i, _ref;
