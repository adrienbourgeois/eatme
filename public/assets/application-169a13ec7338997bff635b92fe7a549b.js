...
(function() {
  var init_mobile, load_more_photos_mobile, page;

  page = 1;

  load_more_photos_mobile = function() {
    return $.ajax({
      url: "/photos?page=" + page,
      dataType: "json",
      contentType: "application/json",
      success: function(ret) {
        var i, image, li, vicinity, _i, _ref, _results;
        alert("go");
        _results = [];
        for (i = _i = 0, _ref = ret.length - 1; 0 <= _ref ? _i <= _ref : _i >= _ref; i = 0 <= _ref ? ++_i : --_i) {
          ...
          li.append(image);
          li.append(vicinity);
          _results.push($("div#just_eaten").find('ul.edgetoedge').append(li));
        }
        return _results;
      },
      beforeSend: function() {},
  ...
  init_mobile = function() {
    $("a#just_eaten_link").on('click', function() {
      page = 1;
      $("div#just_eaten").find('ul.edgetoedge').find("li").remove();
      return load_more_photos_mobile();
    });
    return $("#more").on('click', function(event) {
      event.preventDefault();
      return load_more_photos_mobile();
    });
  };
...
(function() {
  var end, getDocHeight, get_location, init, initialize, just_eaten, latitude, load_more_listener_off, load_more_listener_on, load_more_photos, load_more_photos_when_page_bottom_reached, longitude, map, marker, page, show_map_listener;
  ...
  load_more_photos = function(event) {
    event.preventDefault();
    return $.ajax({
      url: "/photos?page=" + page,
      dataType: "json",
      contentType: "application/json",
      success: function(ret) {
        var col1, col2, food_picture, i, image, j, link1, link2, main_col, main_row, minutes_ago, row, titre, vicinity, _i, _j, _ref, _ref1;
        if (ret.length % 3 !== 0 || ret.length === 0) {
          end = true;
        }
        for (j = _i = 0, _ref = ret.length - 1; _i <= _ref; j = _i += 3) {
          main_row = $("<div class='row'></div>");
          for (i = _j = j, _ref1 = j + 2; j <= _ref1 ? _j <= _ref1 : _j >= _ref1; i = j <= _ref1 ? ++_j : --_j) {
      ...
      beforeSend: function() {
        ...
        return $(".pretty_button").append(spinner);
      },
      complete: function() {
        var button_text;
  ...
  show_map_listener = function() {
    $("a.show_map").off("click", function() {});
    return $("a.show_map").on("click", function() {
  ...
  get_location = function() {
    var page_name;
    page_name = $("span.page").data("page_name");
    if (page_name === "places_finder") {
      if (navigator.geolocation) {
        return navigator.geolocation.getCurrentPosition(function(position) {
          return self.location = "places?latitude=" + position.coords.latitude + "&longitude=" + position.coords.longitude;
        });
      } else {
  ...
  $(function() {
    init();
    return $(document).on("page:change", init);
  });
