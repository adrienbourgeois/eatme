...
(function() {
  var close_places, close_places_loading, end_close_places, end_just_eaten, getDocHeight, initialize_map, just_eaten_loading, last_page, latitude, latitude_user, load_more_listener_off, load_more_listener_on, load_more_photos_when_page_bottom_reached, loading, longitude, longitude_user, map, marker, page_close_places, page_just_eaten, popular_places, radius_gv, refresh_listeners, show_map_listener, show_place, show_place_listener, spinner_off, spinner_on;
  ...
  load_more_photos_when_page_bottom_reached = function() {
    if ($(window).height() + $(window).scrollTop() - getDocHeight() > -200) {
      ...
      if (window.location.hash === "#close_places" && radius_gv !== -1 && !end_close_places) {
        return close_places_loading(radius_gv);
      }
    }
  };
  ...
  close_places_loading = function(radius) {
    return $.ajax({
      ...
      success: function(ret) {
        ...
        if (ret.length === 0) {
          ...
          for (i = _i = 0, _ref = ret.length - 1; 0 <= _ref ? _i <= _ref : _i >= _ref; i = 0 <= _ref ? ++_i : --_i) {
            ...
            for (j = _j = 0, _ref1 = ret[i]['photos'].length - 1; 0 <= _ref1 ? _j <= _ref1 : _j >= _ref1; j = 0 <= _ref1 ? ++_j : --_j) {
  ...
  close_places = function(radius) {
    ...
    if (navigator.geolocation) {
      return navigator.geolocation.getCurrentPosition(function(position) {
        ...
        return close_places_loading(radius);
      });
    } else {
