...
(function() {
  var close_places, close_places_loading, end_close_places, end_just_eaten, getDocHeight, initialize_map, just_eaten_loading, last_page, latitude, latitude_user, load_more_listener_off, load_more_listener_on, load_more_photos_when_page_bottom_reached, longitude, longitude_user, map, marker, page_close_places, page_just_eaten, popular_places, rayon_gv, show_map_listener, show_place;
  ...
  load_more_listener_on = function() {
    return $(window).bind("scroll", load_more_photos_when_page_bottom_reached);
  };
  ...
  close_places_loading = function(rayon) {
    return $.ajax({
      ...
      success: function(ret) {
        ...
        if (ret.length === 0) {
          if (page_close_places === 1) {
            ...
            return $("ul.edgetoedge#close_places").append(li);
          } else {
      ...
      beforeSend: function() {
        ...
        return $("#spinner_close_places")[0].style.display = "inline";
      },
      complete: function() {
        load_more_listener_on();
        return $("#spinner_close_places")[0].style.display = "none";
      }
    });
  };
  ...
  just_eaten_loading = function() {
    return $.ajax({
      ...
      beforeSend: function() {
        ...
        load_more_listener_off();
        return $("#spinner_just_eaten")[0].style.display = "inline";
      },
      complete: function() {
        load_more_listener_on();
  ...
  show_place = function(id) {
    ...
    return $.ajax({
      ...
      beforeSend: function() {
        ...
        return $("#spinner_show_place")[0].style.display = "inline";
      },
      complete: function() {
        return $("#spinner_show_place")[0].style.display = "none";
      }
    });
  };
    ...
    if ($("ul.edgetoedge#popular_places").find("li").length === 0) {
      return $.ajax({
        ...
        beforeSend: function() {
          ...
          return $("button.show_place").off('click');
        },
        complete: function() {
