...
(function() {
  var end, first_time, getDocHeight, get_close_places, get_location, get_popular_places, init, initialize, just_eaten, last_page, latitude, latitude_user, load_more_listener_off, load_more_listener_on, load_more_photos, load_more_photos_when_page_bottom_reached, longitude, longitude_user, map, marker, page, show_map_listener, show_place;
  ...
  get_close_places = function(rayon) {
    return $.ajax({
